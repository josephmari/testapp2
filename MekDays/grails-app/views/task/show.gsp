			...
			<ol class="property-list task">
				...
				<li class="fieldcontain">
					<span id="assignedTo-label" class="property-label"><g:message code="task.assignedTo.label" default="Assigned To" /></span>
						...
						<span class="property-value" aria-labelledby="assignedTo-label"><g:link controller="mekUser" action="show" id="${taskInstance?.assignedTo?.id}">${taskInstance?.assignedTo?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="event-label" class="property-label"><g:message code="task.event.label" default="Event" /></span>
						...
						<span class="property-value" aria-labelledby="event-label"><g:link controller="mekEvent" action="show" id="${taskInstance?.event?.id}">${taskInstance?.event?.encodeAsHTML()}</g:link></span>
